...
public class UserRepoMonitor {
    ...
    @AfterReturning(pointcut = "execution(* com.ps.aspects.*Service*.update*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.ps.aspects.*Service*.updateUsername(..))", throwing = "e")
    ...
    @Around("execution(* com.ps.aspects.*Repo*.find*(..))")
